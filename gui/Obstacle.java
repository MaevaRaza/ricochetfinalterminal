 ...
 *  Enregistre des grilles avec des murs autour d'eux sur la carte
 *      记录相邻四个位置能否直接抵达该点
 *      Enregistre si les quatre positions adjacentes peuvent atteindre directement le point
 *      记录该点是否存在棋子
 *      Enregistre s'il y a un pion au point
 */
public class Obstacle {
     ...
     *  注意下标区间[0,15]
     *  Note l'intervalle d'indice [0,15]
     */
    int row = 0;
    /**
     * 当前点的列号
     ...
     *  传入行号与列号，获取对应的 坐标字符串
     *  Transmet le numéro de ligne et le numéro de colonne pour obtenir la chaîne de coordonnées correspondante
