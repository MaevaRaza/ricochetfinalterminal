...
public class Controller {
    private static final double WIDTH = 700.0D;
    ...
    /**
     * 用于记录当前被操作的棋子下标
     * Utilisé pour enregistrer l'indice du robot en cours d'utilisation
     */
    ...
    /**
     * 棋子的图片(提前进行加载，方便复用)
     * La photo du robot (chargée à l'avance, facile à réutiliser)
     */
